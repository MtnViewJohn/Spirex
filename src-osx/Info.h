...
{
    IBOutlet NSWindow*          mInfoPanel;
    
    IBOutlet NSTextField*       mVersion;
    IBOutlet NSButton*          mCheckForUpdates;
    IBOutlet NSBox*             mUpdateArea;
    
    NSRect                      mInfoFrameBig;
    NSRect                      mInfoFrameSmall;
